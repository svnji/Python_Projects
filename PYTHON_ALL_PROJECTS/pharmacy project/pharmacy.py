...
class Pharmacy:
    def __init__(self, root):
        ...
        ###### Top Frame #####
        topframe = Frame(self.root, bg='dark blue', bd=10, relief=RIDGE, padx=20)
        topframe.place(x=0, y=62, width=1350, height=400)

        ########  down button frame #######
        down_buttonframe = Frame(
            self.root, bg='dark blue', bd=10, relief=RIDGE, padx=20)
        ...
        add_button = Button(down_buttonframe, text="Add Medicine", command=self.addmedicine, font=(
            "arial", 12, "bold"), width=14, fg="dark blue", bg="white", bd=3, relief=RIDGE, activebackground="light blue",
                            activeforeground="white")
        add_button.grid(row=0, column=0)

        update_button = Button(down_buttonframe, command=self.update_new, text="Update", font=(
            "arial", 13, "bold"), width=14, fg="dark blue", bg="white", bd=3, relief=RIDGE, activebackground="light blue",
                               activeforeground="white")
        update_button.grid(row=0, column=1)

        delete_button = Button(down_buttonframe, text="Delete", font=("arial", 13, "bold"), width=13,
                               fg="dark blue", bg="white", bd=3, relief=RIDGE, activebackground="light blue",
                               activeforeground="white")
        delete_button.grid(row=0, column=2)

        reset_button = Button(down_buttonframe, text="Reset", command=self.clear_new, font=("arial", 13, "bold"),
                              width=12,
                              fg="dark blue", bg="white", bd=3, relief=RIDGE, activebackground="light blue",
                              activeforeground="white")
        ...
        exit_button = Button(down_buttonframe, command=self.root.quit, text="Exit", font=(
            "arial", 13, "bold"), width=10, fg="dark blue", bg="white", bd=3, relief=RIDGE, activebackground="light blue",
                             activeforeground="white")
        exit_button.grid(row=0, column=4)

        search_by = Label(down_buttonframe, text="Search By: ", font=(
            "arial", 15, "bold"), fg="white", bg="dark blue", bd=3, padx=3)
        ...
        self.search_combo["values"] = ("Select Options", "Ref No.", "Medicine Name", "Company Name")
        self.search_combo.grid(row=0, column=6)
        self.search_combo.current(0)

        entry_button = Entry(down_buttonframe, font=("arial", 15, "bold"), fg="dark blue",
                             bg="white", bd=3, width=12, relief=RIDGE, textvariable=self.search_txt)
        entry_button.grid(row=0, column=7)

        search_button = Button(down_buttonframe, text="Search", font=("arial", 13, "bold"), width=10, fg="dark blue",
                               bg="white",
                               bd=3, relief=RIDGE, activebackground="light blue", activeforeground="white",
                               command=self.search_data)
        search_button.grid(row=0, column=8)

        show_button = Button(down_buttonframe, text="Show All", font=("arial", 13, "bold"), fg="dark blue", bg="white",
                             width=10, bd=3, relief=RIDGE, activebackground="light blue", activeforeground="white",
                             command=self.fetch_new)
        show_button.grid(row=0, column=9)

        ######## left small frame #######
        left_smallframe = LabelFrame(topframe, bg='dark blue', bd=10, relief=RIDGE,
        ...
        ref_label = Label(left_smallframe, text="Reference No. :", padx=2, pady=4, font=(
            "times new roman", 13, "bold"), bg="dark blue", fg="white")
        ...
        # self.ref_combo["values"] = ('Select', '01', '02'
        #                             , '03', '04', '05', '06', '07', '08', '09', '10')
        # self.ref_combo.grid(row=0, column=1)
        # self.ref_combo.current(0)
        self.ref_compo_entry = Entry(left_smallframe, textvariable=self.refno_var, width=24, font=(
            "times new roman", 13, "bold"), fg="dark blue", bg="white")
        self.ref_compo_entry.grid(row=0, column=1)
        ...
        self.medname_entry = Entry(left_smallframe, textvariable=self.medicine_var, width=24, font=(
            "times new roman", 13, "bold"), fg="dark blue", bg="white")
        self.medname_entry.grid(row=3, column=1)
        # 5
        ...
        # image 2
        self.bgg = ImageTk.PhotoImage(file=r".\image\2.jpg")
        ...
        save_bgg = Label(left_smallframe, text="----------- Stay Home Stay Safe -----------",
                         font=("arial", 13, "bold"), bg='dark blue', fg="white")
        save_bgg.place(x=370, y=120, width=400)

        ############ right frame #########
        right_frame = LabelFrame(topframe, bg='dark blue', bd=10, relief=RIDGE, padx=5,
        ...
        # image 1
        self.bg1 = ImageTk.PhotoImage(file=r".\image\left1.jpg")
        lbl_bg1 = Label(right_frame, image=self.bg1)
        lbl_bg1.place(x=0, y=0, width=240, height=100)
        # image 2
        self.bg2 = ImageTk.PhotoImage(file=r".\image\left2.jpg")
        ...
        newframe = Frame(right_frame, bg='dark blue', bd=5, relief=RIDGE)
        newframe.place(x=256, y=160, width=150, height=150)

        ###### button in this frame ###
        add_button = Button(newframe, text="Add", font=("arial", 13, "bold"), width=13, fg="dark blue", bg="white",
                            bd=3, command=self.AddMed, relief=RIDGE, activebackground="light blue", activeforeground="white")
        add_button.grid(row=0, column=0)

        updatenew_button = Button(newframe, text="Update", font=("arial", 13, "bold"), width=13, fg="dark blue", bg="white",
                                  bd=3, command=self.Update_med, relief=RIDGE, activebackground="light blue",
                                  activeforeground="white")
        updatenew_button.grid(row=1, column=0)

        delnew_button = Button(newframe, text="Delete", font=("arial", 13, "bold"), width=13, fg="dark blue", bg="white",
                               bd=3, relief=RIDGE, activebackground="light blue", activeforeground="white",
        ...
        side_frame = Frame(right_frame, bd=4, relief=RIDGE, bg="dark blue")
        ...
        ######### down frame #######
        down_frame = Frame(self.root, bg='dark blue', bd=10, relief=RIDGE)
        ...
        self.info_table = ttk.Treeview(scroll_frame,
                                       column=("ref no", "comp name", "type", "medi name", "lot no", "issue", "exp",
    ...
    def Delete_med(self):
        if self.ref_variable.get() == "":
            ...
            try:
                ...
                # my_cursor.execute("Delete from pharma where Ref_no=? ", (self.ref_variable.get(),))
                # conn.commit()
                my_cursor.execute("Delete from pharma where Med_name=? ", (self.addmed_variable.get(),))
                conn.commit()
                my_cursor.execute("Delete from pharma where Ref_no=? ", (self.ref_variable.get(),))
                conn.commit()
                messagebox.showinfo("Delete", "Successfully Deleted", parent=self.root)
    ...
    #
    #     if self.ref_variable.get() and self.medicine_var.get() == "":
    #         messagebox.showerror("Error", "Ref no is required", parent=self.root)
    #     else:
    #
    #         try:
    #             conn = sqlite3.connect(database=r'pharmacy.db')
    #             my_cursor = conn.cursor()
    #             my_cursor.execute("Delete from pharma where MED_NAME=? ", (self.medicine_var.get(),))
    #             conn.commit()
    #             my_cursor.execute("Delete from pharma where Ref_no=? ", (self.refno_var.get(),))
    #             conn.commit()
    #
    #             messagebox.showinfo("Delete", "Successfully Deleted", parent=self.root)
    #             self.fetch_datamed()
    ...
    def update_new(self):
        ...
        if self.refno_var.get() == "" or self.lotno_var.get() == "" or self.typemed_var.get() == "":
            ...
            new_cursor = conn.cursor()
            new_cursor.execute(
                "Update Information set COMPANY_NAME=?,TYPE_OF_MED=?,MEDNAME=?,LOT_NO=?,ISSUE_DT=?,EXP_DT=?,USES=?,SIDE_EFFECT=?,PRECAUTION=?,DOSAGE=?,PRICE=?,QUANTITY=? where REF_NO=?",
                (
    ...
    def search_data(self):
        ...
        elif selected == "Ref No.":
            new_cursor.execute("Select * from Information where REF_NO=?", (self.search_txt.get(),))
            row = new_cursor.fetchone()
        elif selected == "Medicine Name":
            new_cursor.execute("Select * from Information where MED_NAME=?", (self.search_txt.get(),))
            row = new_cursor.fetchone()
        elif selected == "COMPANY_NAME":
            new_cursor.execute("Select * from Information where COMPANY_NAME=?", (self.search_txt.get(),))
            row = new_cursor.fetchone()
